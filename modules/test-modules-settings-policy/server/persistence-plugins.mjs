...
const MODULE_ID = "test-modules-settings-policy";
...
export function registerPersistencePlugins(context = {}) {
  const pluginId = `${MODULE_ID}-iter2-gates-persistence`;
...
export function createTestModulesSettingsPolicyRepository(options = {}) {
