import { registerReferenceOptionsProviders as legacyRegistrar0 } from "./runtime-adapters/missions-reference-options-providers.mjs";

const TARGET_MODULE_ID = "test-modules-operations-dispatch";
const LEGACY_REGISTRAR_SOURCES = Object.freeze([
  Object.freeze({ legacyModuleId: "missions", register: legacyRegistrar0 })
]);
